...
const Updates = () => {
  return (
    <section className="flex-col justify-items-center w-full max-h-screen text-6xl my-2 p-4 px-30 text-center">
      <div className="flex-col items-center font-sans">
        <h1 className="font-bold mb-6">
          Discover the latest
        </h1>

        <div className="flex flex-col md:flex-row items-center justify-center  font-bold">
