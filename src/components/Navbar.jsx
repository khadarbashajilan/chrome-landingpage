...
const Navbar = () => {
  return (
    <nav className="flex h-16 font-sans border-b border-b-white shadow-sm text-[#5f6368] gap-x-5 justify-start items-center px-4">
      <div className="flex items-center space-x-2 px-4">
        <img src={chromeLogo} alt="Chrome Logo" className="h-8 w-8" />
        <h1 className="text-2xl font-medium">chrome</h1>
      </div>

      <div className="flex space-x-6 ms-4">
        <h2 className="text-md font-medium hover:text-gray-300 cursor-pointer">
          Safety
        </h2>
        <h2 className="text-md font-medium hover:text-gray-300 cursor-pointer">
          By Google
